...
public class CardServiceImp implements CardService {
    ...
    @Override
    public boolean PictureRegCardInfo(MultipartFile userPictureFile, MultipartFile cardPictrueFile, String name, String tel, HttpServletRequest request) {
    ...
    @Override
    public String getCardInfoDetail(String cardNo, Model model) {
    ...
    @Override
    public String getCardInfoEdit(String cardNo, Model model) {
