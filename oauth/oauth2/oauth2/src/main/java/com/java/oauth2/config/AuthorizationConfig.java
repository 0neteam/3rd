...
public class AuthorizationConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationManagerBuilder authenticationManagerBuilder) throws Exception {
        ...
        http.authorizeHttpRequests(r -> {
                    ...
                    r.requestMatchers(HttpMethod.GET, "/signIn","/signUp","/userinfo","/MyPageInfo","/MyPageEdit","/file/**", "/card/detail/**", "/card/edit/**").permitAll();  // GET 요청 허용
                    r.requestMatchers(HttpMethod.POST, "/addClient", "/signUp", "/signIn", "/UserInfoUpdate","/file/**", "/RegCardInfo/**", "/PictureRegCardInfo/**", "/DelCardInfo/**", "/EditDetailUpdateCardInfo/**").permitAll(); // POST 요청 허용
