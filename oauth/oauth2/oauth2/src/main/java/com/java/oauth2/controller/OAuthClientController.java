...
public class OAuthClientController {
  ...
  @GetMapping("")
  public String home(@RequestParam(required = false) String searchKeyWord, @AuthenticationPrincipal CustomOAuth2User oAuth2User, Model model, HttpServletRequest request, HttpServletResponse response, @RequestHeader(value = "Authorization", defaultValue = "") String authorizationHeader) {
