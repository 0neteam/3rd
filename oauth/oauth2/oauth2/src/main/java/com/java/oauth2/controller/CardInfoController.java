...
public class CardInfoController {
    ...
    public String getCardInfoDetail(@RequestParam("cardNo") String cardNo, Model model) {
        return cardService.getCardInfoDetail(cardNo, model);
    }

    @GetMapping("/card/edit")
    public String getCardInfoEdit(@RequestParam("cardNo") String cardNo, Model model) {
    ...
    public ResponseEntity<Map<String, Object>> PictureRegCardInfo (@RequestParam(value = "userPictureFile", required = false) MultipartFile userPictureFile,
        ...
        boolean status = cardService.PictureRegCardInfo(userPictureFile, cardPictrueFile, name, tel, request);
    ...
    public ResponseEntity<Map<String, Object>> EditDetailUpdateCardInfo (@RequestParam(value = "userPictureFile", required = false) MultipartFile userPictureFile,
        ...
        boolean status = cardService.EditDetailUpdateCardInfo(userPictureFile, cardPictrueFile, cardNo, company, position, name, adr, email, tel, fax, memo, request);
